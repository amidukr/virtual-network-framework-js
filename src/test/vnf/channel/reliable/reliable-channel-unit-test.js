...
function(  VNF,
    ...
    QUnit.module("Reliable Channel Unit Tests");
    reliableVNFTest("Sending sequence numbers", function(assert, argument) {
        ...
        Promise.resolve()
        .then(argument.rootCapture.assertLog.bind(null, ['from reliable-endpoint: {"type":"message","messageNumber":0,"message":"message-1"}']))
        .then(argument.rootCapture.assertLog.bind(null, ['from reliable-endpoint: {"type":"message","messageNumber":1,"message":"message-2"}']))
        .then(argument.rootCapture.assertLog.bind(null, ['from reliable-endpoint: {"type":"message","messageNumber":2,"message":"message-3"}']))
